...
<div class='container'>
    ...
    <input type="text" minlength=5 class="form-control" name="question" id="exampleInputquestion" aria-describedby="emailHelp" placeholder="Enter Question">
    <small id="emailHelp" class="form-text text-muted">pls enter title as brief as possible.</small>
      ...
      <div class="form-group">
        ...
        <textarea class="form-control" id="exampleFormControlTextarea1" name="descr" minlength=5 rows="3"></textarea>
